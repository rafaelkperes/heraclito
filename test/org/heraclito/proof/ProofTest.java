...
public class ProofTest {
    ...
    public void serialize_KeepsStringAsitIs_() throws Exception {
        ...
        try (FileOutputStream fileOut = new FileOutputStream("./proof.her");
        ...
        try (FileInputStream fileIn = new FileInputStream("./proof.her");
                ObjectInputStream in = new ObjectInputStream(fileIn)) {
            Proof ret = (Proof) in.readObject();

            System.out.println("Deserialized proof:");
            ...
            try {
                ret.applyRule(Rule.ID.CL, innerExp, outterExp);
            } catch (ProofException pe) {
                fail(pe.getMessage());
            }

            System.out.println("Deserialized after applying a rule:");
            System.out.println(ret);
        } catch (Exception e) {
            System.out.println("Couldn't read from serialized proof.");
        }
